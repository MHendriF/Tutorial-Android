...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_DATA_UPDATE_WORD = "extra_data_word";
    public static final String EXTRA_DATA_ID = "extra_data_id";
    private final String TAG = "Trace "+MainActivity.class.getSimpleName();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == NEW_WORD_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            int id_data = data.getIntExtra(NewWordActivity.EXTRA_REPLY_ID, -1);

            if (id_data != -1){
                mWordViewModel.update(new Word(id_data, word_data));
            }else {
