package com.hendri.tvshow.adapters;
...
import com.hendri.tvshow.databinding.ItemContainerTvShowBinding;
...
public class WatchlistAdapter extends RecyclerView.Adapter<WatchlistAdapter.TVShowViewHolder> {
    ...
    class TVShowViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindTVShow(TVShow tvShow) {
            ...
            itemContainerTvShowBinding.ivDelete.setOnClickListener(view -> watchlistListener.removeTVShowFromWatchlist(tvShow, getAdapterPosition()));
