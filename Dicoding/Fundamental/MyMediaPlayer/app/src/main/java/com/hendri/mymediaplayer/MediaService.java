...
public class MediaService extends Service implements MediaPlayerCallback {
    ...
    public final static String ACTION_CREATE = "mediaservice.create";
    public final static String ACTION_DESTROY = "mediaservice.destroy";
    ...
    private void init() {
        ...
        AssetFileDescriptor afd = getApplicationContext().getResources().openRawResourceFd(R.raw.a_starry_sky);
        try {
