...
import com.hendri.academies.data.source.local.entity.ContentEntity
...
class CourseReaderViewModelTest {
    ...
    @Test
    fun getModules() {
        `when`<ArrayList<ModuleEntity>>(academyRepository.getAllModulesByCourse(courseId)).thenReturn(java.util.ArrayList(dummyModules))
